...
def main():
    ...
    if success:
        ...
        write_to_file("./solvers.cfg", "./solver/bin/mathsat -theory.bv.div_by_zero_mode=1 -theory.fp.minmax_zero_mode=4 -theory.fp.to_bv_overflow_mode=1 -theory.na.div_by_zero_mode=1")
